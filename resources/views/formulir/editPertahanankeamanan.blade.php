            ...
            <div class="tab-content">
                <div id="content-tab-3-a" class="tab-pane active">
                    <div class="subheading">
                        ...
                        <h3>
                            <span class="text-muted">Kegiatan Petahanan dan Keamanan</span>
                        </h3>
                    </div>
                    <div class="row">
                        <div class="col-sm-12">
                            <form action="{{ url('pertahanankeamanan/' . $formulir->id) }}" method="POST" enctype="multipart/form-data">
                                @method('PATCH')
                                @csrf
                                <div class="spacer-10"></div>
                                    ...
                                    {{-- Start syarat permohonan data --}}
                                        ...
                                        <div class="col-sm-12">
                                            <div class="row">
                                                <div class="col-sm-6">
                                                    <label>Upload Surat Perintah baru</label>
                                                </div>
                                                <div class="col-sm-6">
                                                    <input type="hidden" name="old_file" value="{{ $formulir->surat_perintah }}">
                                                    <input type="file" accept="application/pdf" name="surat_perintah">
