<div>
    ...
    <div wire:ignore.self class="modal fade" id="editFormLysimeter" tabindex="-1" role="dialog">
        <div class="modal-dialog" style="width: 655px;">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                    <h4 class="modal-title">Form Edit Lysimeter</h4>
                </div>
                ...
                <div class="modal-footer">
                    ...
                    <button class="btn btn-primary pull-right" wire:click.prevent="updateForm">Update</button>
                </div>
            </div>
        </div>
    </div>
