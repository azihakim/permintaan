<div>
    ...
    <div wire:ignore.self class="modal fade" id="formHujan3" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                    <h4 class="modal-title">Form Tambah Jam 19.01</h4>
                </div>
                ...
                <div class="modal-footer">
                    ...
                    <button class="btn btn-primary pull-right" wire:click.prevent="storeFormHujan3">Submit</button>
                </div>
            </div>
        </div>
    </div>
