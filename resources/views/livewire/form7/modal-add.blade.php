<div>
    ...
    <div wire:ignore.self class="modal fade" id="form7" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
        <div class="modal-dialog" style="width: 1240px;">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                    <h4 class="modal-title">Form Tambah Jam 18.01</h4>
                </div>
                ...
                <div class="modal-footer">
                    ...
                    <button class="btn btn-primary pull-right" wire:click.prevent="storeForm7">Submit</button>
                </div>
            </div>
        </div>
    </div>
