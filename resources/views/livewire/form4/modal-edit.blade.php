<div>
    ...
    <div wire:ignore.self class="modal fade" id="editForm4" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
        <div class="modal-dialog" style="width: 1240px;">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                    <h4 class="modal-title">Form Edit Jam 13.31</h4>
                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-2 ml-12">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <input class="form-control" type="number" step="any" min="0"
                                            name="" id="" wire:model.lazy="ch_openpan4">
                                        @error('ch_openpan4')
                                            <div class="has-error">
                                                <span style="margin-right: 5px;"
                                                    class="glyphicon glyphicon-remove form-control-feedback"
                            ...
                            <div class="col-md-4 mr-20">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <input class="form-control" type="number" step="any" min="0"
                                            name="" id="" wire:model.lazy="h_openpan4">
                                        @error('h_openpan4')
                                            <div class="has-error">
                                                <span style="margin-right: 5px;"
                                                    class="glyphicon glyphicon-remove form-control-feedback"
                                    ...
                                    <div class="has-error">
                                        <span style="margin-right: 5px;" class="form-control-feedback"
                                            aria-hidden="true"></span><label class="control-label"
                                            for="inputError2">{{ $pesanOpenPan4 }}</label>
                                    </div>
                                    {{-- End Pesan --}}
                                    ...
                                    <div class="col-md-3">
                                        <input class="form-control" type="number" step="any" min="0"
                                            name="" id="" wire:model.lazy="ev_openpan4">
                                        @error('ev_openpan4')
                                            <div class="has-error">
                                                <span style="margin-right: 5px;"
                                                    class="glyphicon glyphicon-remove form-control-feedback"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <input class="form-control" type="number" step="any" min="0"
                                            name="" id="" wire:model.lazy="reset_openpan4">
                                        @error('reset_openpan4')
                                            <div class="has-error">
                                                <span style="margin-right: 5px;"
                                                    class="glyphicon glyphicon-remove form-control-feedback"
                                                    aria-hidden="true"></span><label class="control-label"
