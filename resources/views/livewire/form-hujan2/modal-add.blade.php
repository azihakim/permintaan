<div>
    ...
    <div wire:ignore.self class="modal fade" id="formHujan2" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                    <h4 class="modal-title">Form Tambah Jam 16.01</h4>
                </div>
                <div class="modal-body">
                    <form>
                        <div class="row">
                            ...
                            <div class="col-sm-4">
                                <select name="" id="" class="form-control" wire:model="observerHujan2"
                                    required>
