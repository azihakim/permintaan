<div>
    ...
    <div wire:ignore.self class="modal fade" id="editFormAngin-10m-24jam" tabindex="-1" role="dialog"
        aria-labelledby="myModalLabel">
        <div class="modal-dialog" style="width: 1000px;">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                    <h4 class="modal-title">Form Edit Angin 10M 24 Jam</h4>
                </div>
                ...
                <div class="modal-footer">
                    ...
                    <button class="btn btn-primary pull-right" wire:click.prevent="updateForm">Submit</button>
                </div>
            </div>
        </div>
    </div>
