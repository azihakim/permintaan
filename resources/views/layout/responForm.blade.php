...
@section('menu-title', 'Respon Formulir Permintaan')
                                    ...
                                    {{-- Start syarat permohonan data --}}
                                        ...
                                        <div class="col-sm-12">
                                            <div class="row">
                                                ...
                                                {{-- <div class="col-sm-9">
                                                    <embed src="dokumen/{{ $respon->surat_pengantar }}" style="width: 100%">
                                                        <a href="{{ asset('storage/dokumen/' . $respon->surat_pengantar) }}">download</a>
                                                </div> --}}
                                            </div>
                                        </div>
                                        ...
                                        <div class="row col-sm-12">
                                            <div class="col-sm-12">
                                                {{-- <textarea disabled name="deskripsi" class="form-control" style="height: 150px;">{{ $respon->deskripsi }}</textarea> --}}
                                                <div class="helper-text-box">
                                                    <div class="form-helper">Silahkan masukkan deskripsi jika tidak ada
                                                        pilihan di formulir</div>
                                                </div><!-- End .helper-text-box -$respon->
                                            </div>
                                        </div>
